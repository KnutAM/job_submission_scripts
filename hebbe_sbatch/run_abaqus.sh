...
## Example calling line:
 # sbatch -J myjob -o mylog.out -n 10 ~/job_submission_scripts/hebbe_sbatch/run_abaqus.sh -i my.inp -u umat.o -s "12h"
 # Input between "sbatch" and "~/job_submission_scripts/hebbe_sbatch/run_abaqus.sh" set sbatch options (overrides what is in this file)
